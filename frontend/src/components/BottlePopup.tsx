...
const BottlePopup = ({ bottle, onClick }: BottlePopupProps) => {
  return (
    <div
      ...
      className="flex flex-col items-center bg-[#E8C090] p-4 rounded-md shadow-md cursor-pointer transition-all duration-200 transform hover:scale-110 hover:shadow-lg"
    >
      <span
